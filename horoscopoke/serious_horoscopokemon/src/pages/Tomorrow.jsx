...
function Tomorrow() {
  ...
  const {anything, setAnything, notanything, setNotAnything, eggs, baths, tags} = useContext(SearchContext);
  ...
  return (
      <div className={styles.container_tomorrow}>
        ...
        <div className={styles.div_desire_path}>
            ...
            <textarea name="path" className={styles.path_desire} placeholder='What you gonna do!' value={currentDesire !== '' ? `GOAL #${count} -> ${currentDesire}: ${eggs} eggs is nuts, fellow! Don't do this kind of bullshit! From now on here's what's you gonna do: `: 'Tell me your goal and map out your path to achieve it'}></textarea>
        </div>

        <div className={styles.div_msg}>

          <p className={styles.msg_tomorrow}>So far this is an empty list. <br /> For each desire, a very strange <br />path for reach it! {notanything}</p>
        </div>
